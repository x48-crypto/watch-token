<template>
    <b-row class="mt-4 p-0">
        <b-col v-if="!loaded && !loading" lg="6" offset-lg="3">
            <b-card bg-variant="light" title="Yearn Tokens">
                    ...
                    <b-row>
                        ...
                        <b-col lg="12">
                            ...
                            >
                                ...
                                <small
                                    v-show="errors.has('tokenAddress')"
                                    class="text-danger"
                                >
                    ...
                    <b-row>
                        ...
                        <b-col lg="12">
                            ...
                            >
                                <b-form-input
                                    ...
                                    :class="{
                                        'is-invalid': errors.has('tokenName'),
                                    }"
                                >
                                </b-form-input>
                                <small
                                    v-show="errors.has('tokenName')"
                                    class="text-danger"
                                >
                        ...
                        <b-col lg="12">
                            ...
                            >
                                <b-form-input
                                    ...
                                    :class="{
                                        'is-invalid': errors.has('tokenSymbol'),
                                    }"
                                >
                                </b-form-input>
                                <small
                                    v-show="errors.has('tokenSymbol')"
                                    class="text-danger"
                                >
                        ...
                        <b-col lg="12">
                            ...
                            >
                                ...
                                <small
                                    v-show="errors.has('tokenDecimals')"
                                    class="text-danger"
                                >
    ...
    methods: {
            ...
            this.$validator.validateAll().then(async (result) => {
                if (result) {
                    ...
                    this.token.name = await this.promisify(
                        this.instances.token.name
                    );
                    this.token.symbol = await this.promisify(
                        this.instances.token.symbol
                    );
                    this.token.decimals = (
                        await this.promisify(this.instances.token.decimals)
                    ).valueOf();
                    ...
                    if (
                        ...
                        alert(
                            "It seems that it is not a valid Token or you are on the wrong network"
                        );
                        this.loaded = false;
                    } else {
                        this.loaded = true;
        ...
        createTokenPage() {
            this.$validator.validateAll().then((result) => {
                if (result) {
                    document.location.href = this.$withBase(
                        `detail.html?address=${this.token.address}&network=${this.currentNetwork}&logo=${this.token.logo}`
                    );
                }
            });
        },
